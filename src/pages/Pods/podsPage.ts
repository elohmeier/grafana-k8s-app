...
import { alertsOnlyScene, cpuScene, eventsScene, logsScene, memoryScene, namespaceMetadataScene, networkScene, storageScene } from '../common/entityScenes';

export const podsPage = new SceneAppPage({
  title: 'Pods',
