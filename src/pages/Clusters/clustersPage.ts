...
import { alertsOnlyScene, cpuScene, memoryScene, networkScene, resourcesScene, storageScene } from '../common/entityScenes';

export const clustersPage = new SceneAppPage({
  title: 'Clusters',
