...
import { alertsOnlyScene, cpuScene, eventsScene, logsScene, memoryScene, namespaceMetadataScene, networkScene, resourcesScene, storageScene } from '../common/entityScenes';

export const namespacesPage = new SceneAppPage({
  title: 'Namespaces',
